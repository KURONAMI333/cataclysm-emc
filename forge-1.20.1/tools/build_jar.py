...
build/cataclysm_emc-<version>+forge-1.20.1.jar.

The logo PNG is optional here. mods.toml references logoFile="cataclysm_emc.png" --
if that file is absent when this runs, the jar is packed without it and Forge treats
a missing optional logo as no logo at runtime, not a load error.
